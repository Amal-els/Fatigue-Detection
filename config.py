...
try:
    ...
    AiortcRTCConfiguration = Any
    AiortcRTCIceServer = Any
...
def compile_rtc_ice_server(
    ...
    if AIORTC_IMPORT_ERROR is not None:
        raise ModuleNotFoundError(
            "aiortc is required to compile RTC ICE server settings."
...
def compile_rtc_configuration(
    ...
    if AIORTC_IMPORT_ERROR is not None:
        raise ModuleNotFoundError(
            "aiortc is required to compile RTC configuration settings."
        ) from AIORTC_IMPORT_ERROR
